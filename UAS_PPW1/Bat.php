...
$bat = mysqli_query($conn, "SELECT * FROM product WHERE id_kategori = 2");

if ($row = mysqli_fetch_assoc($bat)) {
...
<nav class="py-2 px-7 flex items-center justify-between sticky top-0 z-10" style="background-color: #F8F7F3;">
    ...
    <div class="container mx-auto py-8">
        <h1 class="text-3xl font-bold mb-8" style="color:#964b00; font-family:Poppins;">Pilih Bat yang terbaik untuk anda</h1>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 justify-center">
            <?php foreach($bat as $l) :?>
